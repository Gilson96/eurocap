...
const SectionSix = () => {
    return (
        <div className="flex flex-col items-center  bg-slate-200 justify-evenly w-full text-center h-screen p-3">
            <p className='text-3xl font-bold p-2 w-full'>POS sem limitações por apenas</p>
            ...
            <p className='text-xl'>*O valor apresentado é referente apenas à solução de software, não incluindo equipamentos que devem ser adquiridos a terceiros. Ao preço apresentado acresce a taxa de IVA em vigor.
            </p>
        </div>
    )
}
